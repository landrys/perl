package MyModules::Mailer::LazyScanner::NorwoodLazyScannerMailer;
...
sub BUILD {
	my $self = shift;
	#$self->recipient('adaigle@landrys.com,mgray@landrys.com,fpiergen@landrys.com');
	...
	if ( $self->debug ) {
		...
		$self->recipient('hberwaldt@landrys.com,mgray@landrys.com,fpiergen@landrys.com,jleland@landrys.com');
	}
}
