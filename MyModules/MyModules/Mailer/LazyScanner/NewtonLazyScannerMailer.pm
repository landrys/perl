package MyModules::Mailer::LazyScanner::NewtonLazyScannerMailer;
...
sub BUILD {
	my $self = shift;
	#$self->recipient('ghoffman@landrys.com,mgray@landrys.com,fpiergen@landrys.com');
	...
	if ( $self->debug ) {
		...
		$self->recipient('ghoffman@landrys.com,mgray@landrys.com,fpiergen@landrys.com,jleland@landrys.com');
	}
}
