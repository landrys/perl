package MyModules::Mailer::LazyScanner::WestboroLazyScannerMailer;
...
sub BUILD {
	my $self = shift;
	#$self->recipient('rcoates@landrys.com,mgray@landrys.com,fpiergen@landrys.com');
	...
	if ( $self->debug ) {
		...
		$self->recipient('rcoates@landrys.com,mgray@landrys.com,fpiergen@landrys.com,jleland@landrys.com');
	}
}
