package MyModules::Mailer::LazyScanner::WorcesterLazyScannerMailer;
...
sub BUILD {
	my $self = shift;
	#$self->recipient('jray@landrys.com,mgray@landrys.com,fpiergen@landrys.com');
	...
	if ( $self->debug ) {
		...
		$self->recipient('jray@landrys.com,mgray@landrys.com,fpiergen@landrys.com,jleland@landrys.com');
	}
